        ...
        try {
            ...
            if (hobbies.length != 0) {
                hobbies.map(function (value, key) {
                    ...
                    $("#userEdit-hobbies").append("<li class=\"list-group-item\">" + value.description + " <a href=\"#\"  \n" +
                        "                                                                                           style=\"color: #c92332;\"><i\n" +
                        "                                                    class=\"far fa-times-circle\" id='userEdit-deleteHobby' data-id='"+ value.interestID + "'></i></a></li>")
                    console.log(value);
                });
